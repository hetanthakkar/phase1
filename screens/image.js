...
class App extends React.Component {
  ...
  success = async (value) => {
    ...
    await firebase
      ...
      .set({
        about: this.props.user.userReducer.about,
  ...
  handleimage = async () => {
    ...
    firebase
      ...
      .createUserWithEmailAndPassword(
        this.props.user.userReducer.email,
        this.props.user.userReducer.password
      )
      .then(this.success())
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity onPress={this.alertify} style={styles.uploadLater}>
